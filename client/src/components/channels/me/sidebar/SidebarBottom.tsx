...
export default function SidebarBottom() {
  const user = useStoreHook(userStore, (state) => state.current);
  ...
  return (
    <div className="h-12 flex grow-0 shrink-0 mt-auto bg-neutral-800">
      ...
      <div className="flex justify-center items-center overflow-hidden text-ellipsis">
      ...
      <div className="flex justify-center items-center ml-auto">
        <div
          className="rounded m-2 hover:bg-neutral-700"
